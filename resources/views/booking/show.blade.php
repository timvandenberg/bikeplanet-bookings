    ...
    <div class="w-full sm:px-6 pb-10">
        ...
        <section class="flex">
            <div class="w-2/3 pr-5">
                <div class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg mb-4">
        ...
        <div class="flex justify-between break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg mb-4 p-4">
            <div class="flex items-center">
                <h4 class="text-lg sm:text-xl inline">Extra booking actions</h4>
            </div>
            @include('booking.admin-parts.extra-actions')
        </div>
    </div>
</main>
@endsection
