...
function initBookPersons() {
  ...
  select.addEventListener("change", function (e) {
    var extraPersonCount = parseInt(e.target.value);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.person_row').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.input_person').val('0');

    for (var i = 1; i <= extraPersonCount; i++) {
      document.querySelector(".person_row_".concat(i)).style.display = 'block';
...
function initSeasonSelect() {
  var select = document.querySelector('#select-season');

  if (select) {
    var seasonRows = document.querySelectorAll('.season-row');
    var seasonRowsCurrent;
    select.addEventListener("change", function (e) {
      ...
      if (seasonRowsCurrent = document.querySelectorAll(".season-row.season-".concat(season))) {
...
function initDiscountSelect() {
  var radios = document.querySelectorAll('.discount-radio');
  if (radios.length === 0) return;
  var priceEl = document.querySelector('#booking-price');
  var originalPrice = parseInt(priceEl.getAttribute('data-original-price'));

  var _loop = function _loop() {
    var radio = radios[i];
    radios[i].addEventListener('click', function (e) {
      var discount = parseInt(e.target.value);
      priceEl.value = originalPrice - discount * originalPrice / 100; // buttons states
...
function initInputListener() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#name').on('keyup', function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#name_person_1').val(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#name').val());
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#email').on('keyup', function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#email_person_1').val(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#email').val());
  });
}
...
__webpack_require__(/*! /Users/timvandenberg/lamalama/valet/bikeplanet-bookings/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/timvandenberg/lamalama/valet/bikeplanet-bookings/resources/css/app.css */"./resources/css/app.css");
