...
<main class="sm:container sm:mx-auto">
    <div class="w-full sm:px-6 pb-10">
        ...
        <div class="bg-gray-100 py-4">
            <a href="/home" class="btn-primary relative inline-block w-auto select-none font-bold whitespace-no-wrap px-6 py-2 border-orange-500 border rounded-lg text-base leading-normal no-underline text-gray-100 bg-orange-500 text-center ml-6 sm:ml-0">Back</a>
        </div>
        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                    ...
                    <div class="relative w-full sm:w-auto">
                        ...
                        <div class="flex flex-wrap mb-2">
                            <div class="w-full sm:w-1/2 mb-2 sm:mb-0">
                                <p>
                                    <span class="font-bold">Start date:</span> <span class="font-normal">{{ $tour->start_date }}</span>
                                </p>
                            </div>

                            <div class="w-full sm:w-1/2">
                                <p>
                                    <span class="font-bold">End date:</span> <span class="font-normal">{{ $tour->end_date }}</span>
                                </p>
                            </div>
                        </div>
                        <div class="flex flex-wrap mb-2">
            ...
            <div class="w-full flex justify-between p-6 pb-0">
                <div class="flex items-end">
                    <p class="text-xl font-bold w-full">Active Bookings</p>
                </div>
                <a href="{{ route('tours.export', $tour->id) }}" class="inactive relative inline-block w-auto select-none font-bold whitespace-no-wrap px-6 py-2 border-orange-500 border rounded-lg text-base leading-normal no-underline text-gray-100 bg-orange-500 text-center">Export Guest list</a>
            </div>
